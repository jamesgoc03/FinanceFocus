...
let progreso1 = setInterval (()=>{
    ...
    progresoCircularValor1.textContent = `${valorProgresoInicio1}%`;
...
let progreso2 = setInterval (()=>{
    ...
    progresoCircularValor2.textContent = `${valorProgresoInicio2}%`;
...
let progreso3 = setInterval (()=>{
    ...
    progresoCircularValor3.textContent = `${valorProgresoInicio3}%`;
